...
async def _search_via_agent(keywords: str) -> str:
    ...
    agent = workflows_mistralai.Agent(
        ...
        instructions=(
            ...
            "If you cannot find any relevant documents, return all the text you can find, even if it is not relevant."
            "The final answer must be the exact text of the documents with all formatting preserved and additional metadata."
        ),
